# Build Logic - Plugins - HCIM Parser

The **HcimParserPlugin** automates handling FHIR-related data handling shared across Web, iOS, and
Android platforms.
...
- **mgo-hcim-api.iife.js** → The Javascript file that contains functions to handle FHIR data.
...
- **mgo-fhir-data.iife.version** -> Defines the version of the shared code.

---

## Step 2: Move Files

The downloaded **mgo-hcim-api.iife.js** and **mgo-fhir-data.iife.version** files are moved to the correct module.
