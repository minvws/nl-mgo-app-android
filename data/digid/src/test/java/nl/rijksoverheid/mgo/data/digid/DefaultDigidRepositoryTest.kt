...
internal class DefaultDigidRepositoryTest {
    ...
    fun testLoginSuccess() =
        runTest {
            ...
            testServer.enqueueJson(json = getTestServerBodyForUnitTest(filePath = "response/start_response.json"))
    ...
    private fun getRepository(): DefaultDigidRepository {
        ...
        return DefaultDigidRepository(vadApi = vadApi, environmentRepository = TestEnvironmentRepository())
    }
}
