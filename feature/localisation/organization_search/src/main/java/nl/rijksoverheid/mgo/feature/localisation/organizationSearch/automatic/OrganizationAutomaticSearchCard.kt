...
import nl.rijksoverheid.mgo.feature.localisation.organizationSearch.OrganizationSearchCardState
import nl.rijksoverheid.mgo.feature.localisation.organizationSearch.R
import nl.rijksoverheid.mgo.feature.localisation.organizationSearch.TEST_TAG_ORGANIZATION_SEARCH_CARD
import nl.rijksoverheid.mgo.framework.copy.R as CopyR

@Composable
fun OrganizationAutomaticSearchCard(
...
@PreviewLightDark
@Composable
internal fun OrganizationAutomaticSearchCardAddPreview() {
    MgoTheme {
...
@PreviewLightDark
@Composable
internal fun OrganizationAutomaticSearchCardAddedPreview() {
    MgoTheme {
        OrganizationAutomaticSearchCard(
