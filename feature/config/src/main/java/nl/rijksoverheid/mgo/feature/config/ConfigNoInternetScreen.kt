...
@Composable
internal fun ConfigNoInternetScreen() {
        ...
        content = { innerPadding ->
            ColumnWithButton(
                ...
                Image(
                    ...
                    painter = painterResource(id = R.drawable.illustration_no_internet),
                    contentDescription =
                    null,
                )
                ...
                Text(
                    ...
                    text = stringResource(id = CopyR.string.config_no_internet_title),
                ...
                Text(
                    ...
                    text = stringResource(id = CopyR.string.config_no_internet_description),
...
@DefaultPreviews
@Composable
internal fun ConfigNoInternetScreenPreview() {
    MgoTheme {
        ConfigNoInternetScreen()
    }
}
