...
internal class OrganizationAutomaticSearchScreenViewModelTest {
    @get:Rule
    val mainDispatcherRule = MainDispatcherRule()

    private val organizationRepository = TestOrganizationRepository()
    private val viewModel by lazy {
        OrganizationAutomaticSearchScreenViewModel(organizationRepository)
    }
    ...
    private suspend fun assertViewState(viewState: OrganizationAutomaticSearchScreenViewState) {
